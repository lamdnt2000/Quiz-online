        ...
        try {
            ...
            if (url!=null && url.endsWith(".html")) {
                if (member != null) {
                    redirect = true;
                    url = path;
                    if (member.getRole().equals(AccessUtils.ADMIN_ROLE)) {
                        url = path + ADMIN_PATH;
                    }
                }
                ...
                if (member == null) {
                    redirect = true;
                    url = indexPage.get("login");
                } else {
                    String adminUri = path+ADMIN_PATH;
                    if (member.getRole().equals(AccessUtils.ADMIN_ROLE) && !uri.startsWith(adminUri)) {
                        redirect = true;
                        url = adminUri;
                    } else if (member.getRole().equals(AccessUtils.STUDENT_ROLE) && uri.startsWith(adminUri)) {
                        redirect = true;
                        url = path;
                    }
                }
